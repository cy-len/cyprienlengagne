...
export const load: LayoutLoad = async ({ fetch, url }) => {
    const promises = [
        artkytClient.getBio(PUBLIC_ARTKYT_SHORT_BIO_ID, "en", { fetchFunction: fetch }),
        artkytClient.getNewsList("en", { pageSize: 3 }, { fetchFunction: fetch }),
        artkytClient.getConcertsList("en", upcomingConcertsFilter(), { pageSize: 5 }, { fetchFunction: fetch }),
    ];
